...
export default function Cursor() {
  ...
  return (
      ...
      <motion.div 
        ...
        className={`cursor-container ${isHovered ? 'cursor--hover' : ''} ${isTextHovered && !isHovered ? 'cursor--hover-text' : ''} ${isHovered && isPressed ? 'cursor--active' : ''} ${!isMouseInWindow ? 'cursor--hidden' : ''}`}>
